...
class GPCoregionalizedWithMeanRegression(GP):
	...
	def __init__(self, X_list, Y_list, kernel=None, likelihoods_list=None,
				 mean_function=None, name='GPCR', W_rank=1, kernel_name='coreg'):
		# Input and Output
		...
		super(GPCoregionalizedWithMeanRegression, self).__init__(X, Y, kernel, likelihood,
																 mean_function,
