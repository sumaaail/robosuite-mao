...
# def train_reward_GP_model(memory):
# 	""" Train reward GP model"""
# 	memory = [[np.array([1.0, 2.0]), np.array(1.0, 2.0), [1]], [np.array([1.0, 2.0]), np.array(1.0, 2.0), [1]]]
# 	input_X = memory[:, 1]
#
# 	return None
...
if __name__ == '__main__':
	memory = [[np.array([1.0, 2.0]), np.array([1.0, 2.0]), [1]],
			  [np.array([1.0, 2.0]), np.array([1.0, 2.0]), [1]]]
	input_X = memory[:][1]
