...
def learn(network, env, seed=None, nsteps=20, nstack=4, total_timesteps=int(80e6), q_coef=0.5, ent_coef=0.01,
    ...
    trust_region        bool, whether or not tensorflow-pytorch estimates the gradient KL divergence between the old and updated policy and uses it to determine step size  (default: True)
